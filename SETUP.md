...
To get your blog live at `https://cijamie.github.io/` with comments enabled, follow these steps:

### 1. Upload to GitHub
1. In your `cijamie.github.io` repository folder, ensure your git remote is configured:
   ```powershell
   git remote -v
...
1. Go to your repository on GitHub: `https://github.com/cijamie/cijamie.github.io`.
...
4. Under **Build and deployment**:
   ...
   * Click **Save**.
5. GitHub will now automatically build and publish your site! Within a minute or two, it will be live at `https://cijamie.github.io/`.
